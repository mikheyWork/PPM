...
open class SideMenuManager: NSObject {
    ...
    open var menuAllowPushOfSameClassTwice = false
     ...
     */
    open var menuWidth: CGFloat = min(round(min((appScreenRect.width), (appScreenRect.height)) * 0.75), 305)
    ...
    open var menuShadowColor = UIColor.white
